...
const AddNewStaffForm = () => {
  return (
    <div className="bg-white rounded-2xl shadow-lg p-5 md:p-6 mt-6">
      <form>
        <section>
          <h2 className="text-lg font-semibold text-nimasa-dark-text mb-6">Personal Information</h2>
        ...
        <section className="mt-10">
          <h2 className="text-lg font-semibold text-nimasa-dark-text mb-6">Role and Access</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
        ...
        <div className="mt-10 flex justify-center">
          <button
            type="submit"
            className="bg-nimasa-blue text-white font-bold py-2.5 px-12 rounded-lg text-base shadow-lg hover:bg-blue-700 transition-colors"
          >
            Save Staff
          </button>
        </div>
