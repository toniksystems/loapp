  ...
  return (
    <div className="overflow-x-auto">
      <div className="min-w-[1000px]">
        {/* Header */}
        <div className="grid grid-cols-12 gap-4 px-4 pb-4 text-sm font-bold text-gray-500 uppercase">
        ...
        <div className="divide-y divide-gray-100">
          {logs.map((log) => (
            <div key={log.logId} className="grid grid-cols-12 gap-4 items-start py-3 px-4 text-sm text-gray-700">
