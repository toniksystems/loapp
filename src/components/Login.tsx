...
const Login = () => {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 md:p-16 max-w-lg w-full mx-auto border-2 border-gray-200">
      <div className="flex flex-col items-center space-y-8">
        <img src={logoUrl} alt="NIMASA Logo" className="h-28 w-28" />

        <div className="text-center">
          <h1 className="text-3xl md:text-4xl font-bold text-black">NIMASA Leave Portal</h1>
          <p className="text-lg md:text-xl text-gray-700 mt-4">Please Sign into your account</p>
        </div>
        ...
        <form onSubmit={handleSignIn} className="w-full space-y-6">
          <div>
            ...
            <input
              ...
              className="w-full px-6 py-4 bg-input-bg rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-nimasa-blue"
            />
          </div>

          <div>
            <label htmlFor="password" aria-label="Password" className="block text-sm font-bold text-gray-800 mb-2">
              Password
            </label>
            <input
              type="password"
          ...
          <button
            type="submit"
            className="w-full bg-nimasa-blue text-white font-bold py-4 rounded-full text-lg hover:bg-blue-700 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-nimasa-blue"
          >
            Sign In
          </button>
        </form>
