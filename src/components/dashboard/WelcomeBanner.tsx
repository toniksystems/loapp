const WelcomeBanner = () => {
    ...
    return (
        <div className="flex items-center gap-5">
            <img src={profileImageUrl} alt="Akin" className="h-16 w-16 rounded-full border-4 border-white shadow-lg" />
            <div>
                <h1 className="text-xl font-bold text-nimasa-dark-text">Welcome, Akin!</h1>
                <p className="text-base text-nimasa-dark-text mt-0.5">Marine Safety Officer</p>
                <p className="text-base text-nimasa-dark-text">Marine Environment Management</p>
            </div>
        </div>
    );
}
