const WelcomeBanner = () => {
    ...
    return (
        <div className="flex items-center gap-8">
            <img src={profileImageUrl} alt="Akin" className="h-24 w-24 rounded-full border-4 border-white shadow-lg" />
            <div>
                <h1 className="text-3xl font-bold text-nimasa-dark-text">Welcome, Akin!</h1>
                <p className="text-xl text-nimasa-dark-text mt-1.5">Marine Safety Officer</p>
                <p className="text-xl text-nimasa-dark-text">Marine Environment Management</p>
            </div>
        </div>
    );
}
