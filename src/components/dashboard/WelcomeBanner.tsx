const WelcomeBanner = () => {
    ...
    return (
        <div className="flex items-center gap-4">
            <img src={profileImageUrl} alt="Akin" className="h-14 w-14 rounded-full border-4 border-white shadow-lg" />
            <div>
                <h1 className="text-lg font-bold text-nimasa-dark-text">Welcome, Akin!</h1>
                <p className="text-sm text-nimasa-dark-text mt-1">Marine Safety Officer</p>
                <p className="text-sm text-nimasa-dark-text">Marine Environment Management</p>
            </div>
        </div>
    );
}
