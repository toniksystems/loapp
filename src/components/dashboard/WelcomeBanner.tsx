const WelcomeBanner = () => {
    ...
    return (
        <div className="flex items-center gap-6">
            <img src={profileImageUrl} alt="Akin" className="h-40 w-40 rounded-full border-4 border-white shadow-lg" />
            <div>
                <h1 className="text-4xl font-bold text-nimasa-dark-text">Welcome, Akin!</h1>
                <p className="text-xl text-nimasa-dark-text mt-2">Marine Safety Officer</p>
