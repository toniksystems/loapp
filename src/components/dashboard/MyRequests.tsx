...
const StatusBadge = ({ status }: { status: 'Approved' | 'Rejected' }) => {
    ...
    return (
        <div className={`flex items-center justify-center gap-2 px-4 py-1 rounded-full text-white ${isApproved ? 'bg-nimasa-green' : 'bg-nimasa-red'}`}>
...
const MyRequests = () => {
    return (
        <div className="bg-white rounded-3xl shadow-md p-8">
            <h2 className="text-3xl font-medium text-nimasa-dark-text mb-6">My Requests</h2>
                        ...
                        {requests.map((req, index) => (
                            <div key={index} className="border-t border-gray-200 pt-4">
                                <div className="grid grid-cols-12 gap-4 items-center px-4">
                                    <div className="col-span-3 flex items-center gap-2 text-lg">
                                    ...
                                    <div className="col-span-2 text-base text-gray-600 text-center">{req.date}</div>
