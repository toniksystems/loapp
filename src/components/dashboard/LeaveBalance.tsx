  ...
  return (
    <div className="bg-white rounded-3xl shadow-md p-8">
      <div className="flex flex-col sm:flex-row justify-between items-start mb-8 gap-4">
        <h2 className="text-3xl font-medium text-nimasa-dark-text">Leave Balance</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {leaveData.map((leave, index) => (
          <div key={index} className="flex flex-col items-center gap-6">
            ...
            <div className="bg-nimasa-light-blue text-white w-full text-center rounded-2xl p-6">
              <p className="text-5xl font-bold">{`${leave.daysUsed}/${leave.daysTotal}`}</p>
