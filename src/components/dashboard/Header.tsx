...
const Header = ({ onMenuClick }: HeaderProps) => {
  ...
  return (
    <header className="bg-white shadow-md py-5 px-10 flex justify-between items-center lg:justify-end">
      ...
      <div className="flex items-center gap-8">
        ...
        <div className="relative" ref={dropdownRef}>
          <img
            src={profileIconUrl}
            alt="Profile"
            className="h-14 w-14 rounded-full border-2 border-nimasa-blue cursor-pointer"
