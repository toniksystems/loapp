...
const Header = ({ onMenuClick }: HeaderProps) => {
  ...
  return (
    <header className="bg-white shadow-sm py-2 px-4 flex justify-between items-center lg:justify-end">
      ...
      <div className="flex items-center gap-4">
        <div className="relative cursor-pointer">
          ...
          <div className="absolute -top-0.5 -right-0.5 flex h-3 w-3 items-center justify-center rounded-full bg-red-500 text-[9px] font-bold text-white">
            3
          </div>
        </div>
        <div className="relative" ref={dropdownRef}>
          <img
            src={profileIconUrl}
            alt="Profile"
            className="h-8 w-8 rounded-full border-2 border-nimasa-blue cursor-pointer"
