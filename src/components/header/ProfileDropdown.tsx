...
const ProfileDropdown = () => {
  ...
  return (
    <div className="absolute top-full right-0 mt-2 w-80 bg-[#F5F5F5] rounded-2xl shadow-lg border border-gray-200 p-5 z-50">
      <div className="flex flex-col items-center">
        <div className="flex items-center gap-4 self-start">
          <img src={profileImageUrl} alt="Akin Adebola" className="h-16 w-16 rounded-full border-2 border-nimasa-blue" />
          <div className="flex items-center gap-2">
            <span className="h-4 w-4 rounded-full bg-nimasa-green"></span>
            <span className="font-bold text-nimasa-dark-text">In Office</span>
          </div>
        </div>

        <div className="text-center my-6">
          <h3 className="text-2xl font-medium text-nimasa-dark-text">Akin Adebola</h3>
      ...
      <Link
        to="/profile"
        className="flex items-center justify-center gap-3 w-full bg-nimasa-blue text-white font-bold py-3 px-6 rounded-xl text-lg shadow-md hover:bg-blue-700 transition-colors"
      >
        <Pencil size={20} />
