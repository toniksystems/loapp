...
const InfoBox: React.FC<InfoBoxProps> = ({ value, label }) => (
  <div className="border border-gray-300 rounded-lg p-2.5 text-center bg-white">
    ...
    <div className="bg-white rounded-2xl shadow-lg p-5">
      ...
      <div className="mt-5">
        <div className="flex justify-between items-center mb-1.5">
          <span className="text-sm font-medium text-nimasa-dark-text">Usage Progress</span>
          <span className="text-sm font-bold text-nimasa-dark-text">{progress}%</span>
        </div>
