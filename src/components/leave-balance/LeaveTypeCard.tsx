...
const InfoBox: React.FC<InfoBoxProps> = ({ value, label }) => (
  <div className="border border-gray-300 rounded-xl p-3 text-center bg-white">
    ...
    <div className="bg-white rounded-3xl shadow-lg p-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-base text-gray-500">{allocation}</p>
        </div>
      </div>

      <div className="mt-6">
        <div className="flex justify-between items-center mb-1">
          <span className="text-base font-medium text-nimasa-dark-text">Usage Progress</span>
          <span className="text-base font-bold text-nimasa-dark-text">{progress}%</span>
        </div>
      ...
      <div className="mt-6 grid grid-cols-3 gap-4">
        ...
        <InfoBox value={daysAvailable} label="Days Available" />
      </div>
    </div>
  );
};
