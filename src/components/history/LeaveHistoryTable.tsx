    ...
    return (
      <div className="overflow-x-auto">
        <div className="min-w-[800px]">
          <div className="grid grid-cols-12 gap-4 bg-table-header-gray/60 rounded-t-lg px-4 py-3 text-nimasa-dark-text font-bold text-sm">
          ...
          <div className="bg-input-bg/70">
            {leaveHistoryData.map((item, index) => (
              <div key={index} className="grid grid-cols-12 gap-4 items-center px-4 py-2.5 text-nimasa-dark-text text-sm border-b border-white last:border-b-0">
