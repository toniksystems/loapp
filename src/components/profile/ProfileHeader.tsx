...
const ProfileHeader = () => {
    ...
    return (
        <div className="bg-white rounded-2xl shadow-lg p-8 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex flex-col text-center md:text-left md:flex-row items-center gap-8">
                <img src={profileImageUrl} alt="Akin Adebola" className="h-24 w-24 md:h-28 md:w-28 rounded-full border-4 border-nimasa-blue" />
                <div>
                    <h2 className="text-2xl md:text-3xl font-medium text-nimasa-dark-text">Akin Adebola</h2>
                    <p className="text-xl text-gray-600 mt-1.5">Maritime Safety Officer</p>
                    <p className="text-lg text-gray-500 mt-1.5">MS/HR/2015-331</p>
                </div>
            </div>
            <button className="bg-nimasa-blue text-white font-medium py-3 px-8 rounded-full text-xl flex items-center gap-3 hover:bg-blue-700 transition-colors w-full md:w-auto justify-center">
                <Pencil size={22} />
