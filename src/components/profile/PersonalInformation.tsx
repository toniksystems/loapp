...
const PersonalInformation = () => {
    ...
    return (
        <div className="bg-white rounded-3xl shadow-md p-6 md:p-8 mt-8">
            <h3 className="text-2xl md:text-3xl font-medium text-nimasa-dark-text mb-8">Personal Information</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                ...
                <div className="md:col-span-2">
                    <label className="block text-lg font-medium text-nimasa-dark-text mb-2">Home Address</label>
                    <div className="w-full px-6 py-4 bg-input-bg rounded-2xl border border-gray-300 text-nimasa-dark-text text-base md:text-lg min-h-[100px] flex items-center">
