const ManagerWelcome = () => {
    ...
    return (
        <div className="flex items-center gap-6">
            <img src={profileImageUrl} alt="Manager" className="h-40 w-40 rounded-full border-4 border-white shadow-lg" />
            <div>
                <h1 className="text-4xl font-bold text-nimasa-dark-text">Welcome, Manager!</h1>
                <p className="text-xl text-nimasa-dark-text mt-2">Here's an overview of your team's leave status.</p>
            </div>
        </div>
    );
}
