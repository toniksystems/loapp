const ManagerWelcome = () => {
    ...
    return (
        <div className="flex items-center gap-4">
            <img src={profileImageUrl} alt="Manager" className="h-16 w-16 rounded-full border-4 border-white shadow-lg" />
            <div>
                <h1 className="text-xl font-bold text-nimasa-dark-text">Welcome, Manager!</h1>
                <p className="text-base text-nimasa-dark-text mt-1">Here's an overview of your team's leave status.</p>
            </div>
        </div>
    );
}
