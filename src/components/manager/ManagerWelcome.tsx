const ManagerWelcome = () => {
    ...
    return (
        <div className="flex items-center gap-5">
            <img src={profileImageUrl} alt="Manager" className="h-20 w-20 rounded-full border-4 border-white shadow-lg" />
            <div>
                <h1 className="text-2xl font-bold text-nimasa-dark-text">Welcome, Manager!</h1>
                <p className="text-lg text-nimasa-dark-text mt-1.5">Here's an overview of your team's leave status.</p>
            </div>
        </div>
    );
}
