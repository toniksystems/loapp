  ...
  return (
    <div>
        <div className="flex flex-col xl:flex-row gap-8 items-stretch">
          ...
          <div className="flex-grow grid grid-cols-1 sm:grid-cols-3 gap-8">
        ...
        <div className="flex justify-center items-center gap-8 mt-6">
            <div className="flex items-center gap-2">
                ...
                <span className="text-lg font-medium text-nimasa-dark-text">Days Available</span>
            </div>
            <div className="flex items-center gap-2">
                <span className="h-4 w-4 rounded-full bg-nimasa-yellow"></span>
                <span className="text-lg font-medium text-nimasa-dark-text">Days Used</span>
            </div>
        </div>
    </div>
  );
