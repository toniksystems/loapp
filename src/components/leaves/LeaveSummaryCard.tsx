  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-1.5">
        <span className="text-base font-ubuntu text-black">{label}</span>
        <span className="text-base font-ubuntu text-black">{`${used}/${total}`}</span>
      </div>
...
const LeaveSummaryCard = () => {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-5 h-full flex flex-col justify-between">
        <div className="flex justify-between items-start">
            <h3 className="text-lg font-medium text-black">Akin Adebola</h3>
            <img src={profileIconUrl} alt="Akin Adebola" className="h-12 w-12 rounded-full border-2 border-nimasa-blue" />
        </div>
