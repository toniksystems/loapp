  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-8 h-full flex flex-col justify-between">
        <div className="flex justify-between items-start">
            <h3 className="text-2xl font-medium text-black">Akin Adebola</h3>
            <img src={profileIconUrl} alt="Akin Adebola" className="h-16 w-16 rounded-full border-2 border-nimasa-blue" />
        </div>
