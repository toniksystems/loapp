  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-1">
        <span className="text-sm font-ubuntu text-black">{label}</span>
        <span className="text-sm font-ubuntu text-black">{`${used}/${total}`}</span>
      </div>
      <div className="w-full bg-gray-200 rounded-full h-2">
        <div
          className="bg-nimasa-green h-2 rounded-full"
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-4 h-full flex flex-col justify-between">
        <div className="flex justify-between items-start">
            <h3 className="text-base font-medium text-black">Akin Adebola</h3>
            <img src={profileIconUrl} alt="Akin Adebola" className="h-10 w-10 rounded-full border-2 border-nimasa-blue" />
        </div>
