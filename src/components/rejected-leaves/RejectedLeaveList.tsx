...
import RejectedLeaveListItem from './RejectedLeaveListItem';

const rejectedLeaveData: RejectedRequest[] = [
  {
    id: '1',
    employee: {
      name: 'Aisha Lawal',
    ...
    rejection: {
      reason: 'Scheduling Overlap',
      detail: 'Attempted to resubit same dates',
    },
    rejectedDate: '14th July. 2025',
    status: 'Rejected',
  },
  {
    id: '2',
    ...
    rejection: {
      reason: 'Missing Backup Plan',
      detail: 'Critical project handover documentation was incomplete',
    },
    rejectedDate: '17th Sept. 2025',
    status: 'Rejected',
  },
  {
    id: '3',
    ...
    rejection: {
      ...
      detail: 'Leave falls on the date of Commissioning of New Project',
    },
    rejectedDate: '21st Aug. 2025',
    status: 'Rejected',
  },
  {
    id: '4',
    ...
    rejection: {
      reason: 'Staffing Conflict (High Risk)',
      detail: '2 Senior members already out, critical resource shortage',
    },
    rejectedDate: '17th Aug. 2025',
    status: 'Rejected',
  },
  {
    id: '5',
    ...
    rejectedDate: '29th Sept. 2025',
    status: 'Rejected',
  },
];

const RejectedLeaveList = () => {
    return (
        <div className="overflow-x-auto">
            <div className="min-w-[1000px]">
                {/* Header */}
                <div className="grid grid-cols-12 gap-4 px-4 pb-4 text-base font-medium text-nimasa-dark-text border-b-2 border-gray-200">
                    <div className="col-span-3">Employee Name and ID</div>
                    <div className="col-span-2">Leave Type and Duration</div>
                    <div className="col-span-3">Rejection Reason</div>
                    <div className="col-span-2">Rejected Date</div>
                    <div className="col-span-2 text-center">Status</div>
                </div>

                {/* Body */}
                <div className="divide-y divide-gray-200">
                    {rejectedLeaveData.map((request) => (
                        <RejectedLeaveListItem key={request.id} request={request} />
                    ))}
                </div>
            </div>
        </div>
...
export default RejectedLeaveList;
