            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4 items-end">
                <div className="lg:col-span-1">
                    ...
                    <div className="relative">
                        <select defaultValue="Absence Summary" className="w-full appearance-none bg-input-bg border border-gray-300 rounded-lg py-1.5 px-4 text-sm focus:outline-none focus:ring-2 focus:ring-nimasa-blue">
                ...
                <div className="lg:col-span-1">
                    ...
                    <div className="relative">
                        <select defaultValue="All Departmental Sta" className="w-full appearance-none bg-input-bg border border-gray-300 rounded-lg py-1.5 px-4 text-sm focus:outline-none focus:ring-2 focus:ring-nimasa-blue">
                ...
                <div className="lg:col-span-1">
                    ...
                    <div className="relative">
                        <input type="text" defaultValue="01/01/2025" className="w-full bg-input-bg border border-gray-300 rounded-lg py-1.5 pl-9 pr-4 text-sm focus:outline-none focus:ring-2 focus:ring-nimasa-blue" />
                ...
                <div className="lg:col-span-1">
                    ...
                    <div className="relative">
                        <input type="text" defaultValue="31/10/2025" className="w-full bg-input-bg border border-gray-300 rounded-lg py-1.5 pl-9 pr-4 text-sm focus:outline-none focus:ring-2 focus:ring-nimasa-blue" />
                        <Calendar className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-400" />
                    </div>
                </div>
                <div className="lg:col-span-1">
