...
import AllRequestsListItem from './AllRequestsListItem';

const allRequestsData: AllRequest[] = [
  {
    id: '1',
    employee: {
      name: 'Jane Mbaku',
    ...
    status: 'Pending',
    statusDetail: 'Awaiting Second Level Approval',
    requested: {
      date: '16th Oct., 2025',
  ...
  },
  {
    ...
    status: 'Approved',
    statusDetail: 'Full 4 weeks approved per policy',
    requested: {
      date: '15th Sept. 2025',
      days: '20 working days',
    },
  ...
  },
  {
    ...
    status: 'Rejected',
    statusDetail: 'Rejected by Supervisor too many staffs on leave',
    requested: {
      date: '15th Sept. 2025',
      days: '2 working days',
    },
  ...
  },
  {
    ...
    status: 'Approved',
    statusDetail: 'Full 10 days approved per policy',
    requested: {
      date: '24th Sept. 2025',
  ...
  },
  {
    ...
    status: 'Cancelled',
    statusDetail: 'Canceled by employee, training has been shifted',
    requested: {
      date: '24th Sept. 2025',
      days: '3 working days',
    },
        ...
        <div className="overflow-x-auto">
            <div className="min-w-[1200px]">
                ...
                <div className="grid grid-cols-12 gap-4 px-4 pb-4 text-base font-medium text-nimasa-dark-text border-b-2 border-gray-200">
                    ...
                    <div className="col-span-3">Status and Details</div>
                    <div className="col-span-2">Requested Date/Days</div>
                    <div className="col-span-2">Actioned By/Date</div>
                </div>

                {/* Body */}
                <div className="divide-y divide-gray-200">
                    {allRequestsData.map((request) => (
                        <AllRequestsListItem key={request.id} request={request} />
                    ))}
                </div>
            </div>
        </div>
