...
import RejectedLeavesPage from './pages/RejectedLeavesPage';
...
function App() {
  return (
    <Routes>
      <Route path="/" element={<Navigate to="/all-requests" />} />
      ...
      <Route path="/rejected-leaves" element={<RejectedLeavesPage />} />
